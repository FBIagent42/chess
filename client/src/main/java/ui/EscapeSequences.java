...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_DARK_PURPLE = SET_TEXT_COLOR + "92m";
    ...
    public static final String SET_BG_COLOR_DARK_GREY = SET_BG_COLOR + "239m";
    ...
    public static final String SET_BG_COLOR_LIGHTER_GREY = SET_BG_COLOR + "250m";
